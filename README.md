...
It has been tested and used in production with `Debian` virtual servers. Other distros won't likely work at this time.
...
company_admin_list:
  - name: "John Smith"
    ...
    keys:
      active:
        - "ssh-rsa  onni@keksi.io"
      disabled:
        - "ssh-rsa  onnimonni@Onni-MacBook-Air.local"
    shell: "/bin/bash"
    state: present
  - name: "Example Person"
...
I use the same username `john-smith` locally and in servers so that I won't need to provide the username everytime to different programs.
...
## Maintainer
[ximbal](https://github.com/ximbal)
